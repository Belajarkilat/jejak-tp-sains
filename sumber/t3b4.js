...
{n:5, tempat:"Relau & Lombong", sk:"4.3 Pengekstrakan logam dan kesan perlombongan", lampiran:"sungai",
 ...
 soalan:[
 {j:"pilih",t:"Berdasarkan jadual, apakah bukti paling kukuh bahawa lombong menjejaskan sungai?",p:["Stesen B jauh lebih keruh dan berasid berbanding Stesen A","Stesen D mempunyai 12 spesies ikan, iaitu kurang daripada 15","Stesen A mempunyai pH 6.9 yang hampir neutral","Semua stesen mempunyai sekurang-kurangnya tiga spesies ikan"],b:0,u:"Stesen A di hulu menjadi kawalan. Perubahan besar di alur keluar lombong menunjukkan puncanya."},
 {j:"pilih",t:"Nilaikan dakwaan: \"Sungai itu pulih sepenuhnya 8 km dari lombong.\"",p:["Tidak tepat, kerana Stesen D masih lebih keruh dan kurang ikan daripada A","Tepat, kerana kekeruhan Stesen D jauh lebih rendah daripada Stesen B","Tepat, kerana pH Stesen D sudah melebihi 6.5 seperti air biasa","Tidak tepat, kerana sungai tidak pernah pulih selepas dicemari"],b:0,u:"Pulih sepenuhnya bermakna kembali seperti keadaan kawalan di Stesen A."},
 {j:"pilih",t:"Pihak berkuasa hanya mampu melaksanakan SATU langkah segera. Pilihan paling wajar?",p:["Bina kolam takungan supaya lumpur mendap sebelum ke sungai","Pasang papan tanda larangan memancing di sepanjang sungai itu","Lepaskan benih ikan baharu di Stesen B setiap bulan","Pindahkan semua penduduk kampung yang tinggal di hilir sungai"],b:0,u:"Langkah yang menyerang punca pencemaran lebih berkesan daripada merawat kesannya."},
 {j:"pilih",t:"Seorang jurutera mencadangkan batu kapur dikeluarkan daripada relau bagas untuk menjimatkan kos. Nilaikan cadangan itu.",p:["Kurang wajar, kerana bendasing tidak lagi dapat disingkirkan sebagai sanga","Wajar, kerana batu kapur tidak terlibat dalam tindak balas di dalam relau","Wajar, kerana kok sudah cukup untuk menyingkirkan semua bendasing","Kurang wajar, kerana batu kapur ialah sumber utama besi dalam relau"],b:0,u:"Batu kapur terurai kepada kalsium oksida yang bergabung dengan pasir membentuk sanga. Tanpanya, besi yang terhasil bercampur bendasing."},
 {j:"pilih",t:"Dua kaedah pengekstrakan aluminium dicadangkan: (P) panaskan bauksit dengan karbon, (Q) elektrolisis. Keputusan paling wajar?",p:["Q, kerana karbon tidak dapat menurunkan aluminium oksida","P, kerana pemanasan dengan karbon lebih murah daripada elektrolisis","P, kerana aluminium berada di bawah karbon dalam siri","Q, kerana elektrolisis tidak menggunakan sebarang tenaga"],b:0,u:"Kaedah yang murah tidak berguna jika ia tidak berfungsi. Elektrolisis menggunakan banyak tenaga elektrik."},
 {j:"pilih",t:"Bekas lombong timah di Lembah Klang telah dijadikan tasik rekreasi dan tanah lembap. Apakah kelebihan utama pendekatan ini?",p:["Tanah yang rosak diberi kegunaan baharu yang bermanfaat","Kerajaan tidak perlu lagi mengawal perlombongan baharu","Bijih timah yang tinggal dapat terus dilombong di tasik","Air tasik bekas lombong sentiasa selamat untuk diminum"],b:0,u:"Pemulihan menjadikan kawasan terbiar sebagai habitat dan tempat rekreasi, tetapi air bekas lombong masih perlu diuji."},
 {j:"banyak",t:"Pilih SEMUA langkah yang wajar diwajibkan sebelum lombong bauksit baharu dibuka.",p:["Penilaian Kesan Alam Sekeliling yang diluluskan","Pelan pemulihan tanah selepas perlombongan tamat","Kawalan habuk semasa bijih diangkut dengan lori","Pampasan dibayar hanya selepas penduduk mengadu","Perlombongan di tebing sungai untuk memudahkan angkutan"],b:[0,1,2],u:"Pencemaran habuk bauksit di Kuantan pada 2015 menunjukkan akibat apabila kawalan ini diabaikan."},
 {j:"pilih",t:"Mengitar semula tin aluminium menggunakan jauh kurang tenaga berbanding mengekstrak aluminium baharu. Keputusan paling wajar bagi kantin sekolah?",p:["Sediakan tong khas untuk tin aluminium dan hantar ke pusat kitar semula","Buang tin bersama sampah lain kerana aluminium tidak boleh dikitar semula","Bakar tin aluminium supaya isi padu sampah menjadi lebih kecil","Tanam tin di belakang sekolah kerana aluminium mudah reput"],b:0,u:"Kitar semula menjimatkan tenaga dan mengurangkan keperluan melombong bauksit baharu."}],
 bos:{j:"pilih",t:"Sebuah kampung perlu memutuskan sama ada membenarkan lombong bauksit yang membuka 200 peluang pekerjaan, sedangkan sungai berhampiran ialah sumber air minum. Keputusan paling wajar?",p:["Benarkan hanya jika kawalan pencemaran dan pemulihan dikuatkuasakan","Benarkan tanpa syarat kerana peluang pekerjaan lebih penting","Tolak kerana perlombongan tidak pernah membawa sebarang manfaat","Tangguhkan keputusan sehingga sungai itu tercemar dahulu"],b:0,u:"Keputusan yang baik menimbang manfaat ekonomi dan keselamatan air, dan meletakkan syarat yang boleh dipantau."}},
...
{n:6, tempat:"Tanah Bekas Lombong", sk:"4.3 Mereka cipta penyelesaian",
 ...
 soalan:[
 {j:"pilih",t:"Awak mereka bentuk pelan memulihkan tanah bekas lombong di kampung awak. Langkah pertama paling penting?",p:["Uji tanah dan air untuk mengetahui keadaan sebenarnya","Tanam pokok buah-buahan terus tanpa sebarang ujian","Timbus semua kolam lombong dengan sampah domestik","Bina rumah di atasnya kerana tanahnya sudah rata"],b:0,u:"Pelan yang baik bermula dengan data tentang masalah sebenar."},
 {j:"pilih",t:"Ujian menunjukkan tanah bekas lombong itu berasid. Bahan manakah paling sesuai ditambah sebelum menanam?",p:["Kapur pertanian","Garam dapur halus","Cuka beras","Serbuk zink"],b:0,u:"Kapur bersifat bes dan meneutralkan tanah berasid."},
 {j:"pilih",t:"Kolam bekas lombong mahu dijadikan tempat ternakan ikan. Syarat paling penting sebelum ia dimulakan?",p:["Air kolam diuji bebas daripada logam berat","Tebing kolam dicat supaya lebih menarik","Ikan dibeli dalam jumlah paling banyak","Pagar tinggi dibina di sekeliling kolam"],b:0,u:"Logam berat dalam air boleh terkumpul dalam ikan dan akhirnya dalam badan orang yang memakannya."},
 {j:"pilih",t:"Bajet projek pemulihan hanya RM500, tetapi anak pokok hutan berharga RM15 sebatang. Cara paling kreatif?",p:["Semai benih pokok tempatan bersama murid dan penduduk","Tanam lima pokok sahaja dan biarkan selebihnya kosong","Tangguhkan projek sehingga bajet mencukupi sepenuhnya","Beli pokok plastik supaya kawasan itu kelihatan hijau"],b:0,u:"Menyemai sendiri menjimatkan kos dan melibatkan masyarakat."},
 {j:"pilih",t:"Awak mahu membuktikan pelan pemulihan berjaya selepas setahun. Bukti paling meyakinkan?",p:["Bandingkan bilangan spesies dan kualiti air sebelum dan selepas","Tanya penduduk sama ada kawasan itu kelihatan lebih cantik","Kira gambar kawasan itu yang dikongsi di media sosial","Ukur ketinggian satu pokok yang paling cepat membesar"],b:0,u:"Ukuran sebelum dan selepas memberikan bukti yang boleh dibandingkan."},
 {j:"pilih",t:"Sebuah syarikat lombong menawarkan dana tetapi mahu logonya dipaparkan besar di papan tanda projek. Keputusan paling wajar?",p:["Terima dengan syarat projek tetap mengikut pelan komuniti","Tolak terus kerana semua syarikat lombong merosakkan alam","Terima dan ubah pelan mengikut kehendak syarikat itu","Terima tanpa memaklumkan penduduk kampung"],b:0,u:"Dana luar boleh membantu selagi keputusan projek kekal di tangan masyarakat."},
 {j:"pilih",t:"Awak mereka cipta alat mudah untuk memisahkan bijih timah daripada pasir, seperti mendulang. Prinsip sains yang digunakan?",p:["Bijih timah lebih tumpat, jadi ia mendap lebih cepat","Bijih timah lebih ringan, jadi ia terapung di atas air","Bijih timah bermagnet kuat, jadi ia melekat pada dulang","Bijih timah larut dalam air, jadi pasir tertinggal"],b:0,u:"Kasiterit jauh lebih tumpat daripada pasir, jadi air yang digoncang membawa pasir pergi dahulu."},
 {j:"pilih",t:"Masyarakat Orang Asli bergantung pada sungai berhampiran kawasan yang ingin dipulihkan. Pendekatan paling wajar?",p:["Libatkan mereka dan gunakan pengetahuan tempatan mereka","Laksanakan pelan tanpa berbincang kerana pakar lebih tahu","Minta mereka berpindah sementara projek dijalankan","Larang mereka menggunakan sungai itu buat selama-lamanya"],b:0,u:"Masyarakat yang paling lama mengenali kawasan itu selalunya tahu tumbuhan dan corak air yang sesuai."}],
 bos:{j:"buka",
