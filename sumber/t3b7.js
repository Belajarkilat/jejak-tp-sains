...
{n:4, tempat:"Roller Coaster", sk:"7.3 Perubahan tenaga dalam sistem tertutup", lampiran:"trek",
 ...
 {j:"pilih",t:"Jika jisim kereta digandakan kepada 1000 kg, berapakah lajunya di titik B?",p:["Kekal 20 m/s kerana jisim terbatal","Menjadi 40 m/s kerana jisim digandakan","Menjadi 10 m/s kerana kereta lebih berat","Menjadi 0 m/s kerana kereta terlalu berat"],b:0,u:"Dalam mgh = ½mv², m ada di kedua-dua belah dan terbatal."}],
...
{n:5, tempat:"Kren Bengkel", sk:"7.1 / 7.3 Menilai kuasa dan kecekapan", lampiran:"motor",
 ...
 soalan:[
 {j:"pilih",t:"Berdasarkan jadual, motor manakah paling cekap?",p:["Motor P","Motor Q","Motor R","Semua sama cekap"],b:0,u:"P: 20 000 ÷ 25 000 = 80%. R: kira-kira 77%. Q: 50%."},
 {j:"nombor",t:"Berapakah kecekapan Motor Q, dalam peratus?",b:50,tol:0.5,suf:"%",u:"20 000 ÷ 40 000 × 100% = 50%."},
 {j:"pilih",t:"Nilaikan dakwaan: \"Motor R paling baik kerana paling berkuasa.\"",p:["Belum tentu, kerana harga dan kecekapan juga perlu dinilai","Tepat, kerana kuasa ialah satu-satunya ukuran penting","Tepat, kerana motor paling mahal sentiasa paling baik","Salah, kerana Motor R paling lambat mengangkat beban"],b:0,u:"Motor terbaik bergantung pada keperluan pengguna."},
 {j:"pilih",t:"Sebuah bengkel kecil mengangkat beban beberapa kali sehari dan mahu menjimatkan bil elektrik. Pilihan paling wajar?",p:["Motor P, kerana paling cekap walaupun perlahan","Motor Q, kerana harganya paling murah di pasaran","Motor R, kerana paling laju","Motor Q, kerana ia paling berkuasa"],b:0,u:"Kelajuan tidak penting bagi bengkel kecil, tetapi tenaga yang dibazirkan dibayar setiap hari."},
 {j:"pilih",t:"Sebuah pelabuhan sibuk perlu mengangkat beban secepat mungkin sepanjang hari. Pilihan paling wajar?",p:["Motor R, kerana laju dan masih agak cekap","Motor P, kerana paling murah dikendalikan","Motor Q, kerana paling murah dibeli","Tiada, kerana semua motor terlalu perlahan"],b:0,u:"Masa sangat bernilai di pelabuhan, dan Motor R hanya sedikit kurang cekap daripada P."},
 {j:"pilih",t:"Tenaga yang dibazirkan oleh Motor Q kebanyakannya bertukar menjadi:",p:["Haba dan bunyi","Tenaga keupayaan kenyal","Tenaga kimia","Cahaya"],b:0,u:"Motor yang kurang cekap menjadi panas dan bising."},
 {j:"banyak",t:"Pilih SEMUA langkah yang wajar untuk mengurangkan tenaga yang dibazirkan oleh motor.",p:["Minyakkan bahagian yang bergerak","Selenggara motor secara berkala","Pilih motor yang lebih cekap","Biarkan motor hidup walaupun tidak digunakan","Tambah beban melebihi had motor"],b:[0,1,2],u:"Geseran dan beban berlebihan menambah tenaga yang menjadi haba."},
 {j:"pilih",t:"Seorang murid mendakwa kereta mainan berspring lebih mesra alam daripada kereta mainan berbateri. Nilaikan dakwaan itu.",p:["Munasabah, kerana tenaganya daripada tangan dan tiada sisa bateri","Salah, kerana spring mencipta tenaga daripada tiada","Salah, kerana kereta berspring langsung tidak mempunyai sebarang tenaga","Munasabah, kerana spring tidak pernah haus atau rosak"],b:0,u:"Spring hanya menyimpan tenaga daripada kerja tangan, dan tidak menghasilkan sisa bateri."}],
 bos:{j:"pilih",t:"Pengurus taman air memilih antara gelongsor X setinggi 12 m dan gelongsor Y setinggi 6 m. Pengunjung termasuk kanak-kanak kecil. Keputusan paling wajar?",p:["Bina Y untuk kanak-kanak dan hadkan X kepada pengunjung dewasa","Bina X sahaja kerana lebih seronok untuk semua","Bina Y sahaja kerana gelongsor tinggi tidak berguna","Bina X tanpa sekatan kerana air menghilangkan semua laju"],b:0,u:"Gelongsor lebih tinggi memberi lebih banyak tenaga kinetik di bawah, jadi laju lebih tinggi dan lebih berisiko bagi kanak-kanak."}},
...
{n:6, tempat:"Taman Permainan", sk:"7.3 Mereka cipta menggunakan perubahan tenaga",
 ...
 soalan:[
 {j:"pilih",t:"Awak mereka kereta mainan berspring untuk pertandingan jarak. Ciri paling penting untuk menambah jarak?",p:["Spring yang menyimpan lebih tenaga dan roda yang licin","Badan kereta seberat mungkin supaya lebih stabil di atas trek","Roda bergetah tebal yang banyak geseran","Warna terang supaya kelihatan laju"],b:0,u:"Lebih banyak tenaga kenyal dan kurang geseran bermakna lebih banyak tenaga kinetik untuk bergerak."},
 {j:"pilih",t:"Awak mereka buaian untuk taman permainan. Ciri keselamatan paling penting?",p:["Lantai lembut di bawah buaian untuk menyerap hentaman","Buaian dibina setinggi mungkin supaya lebih seronok dimainkan","Lantai simen supaya mudah dibersihkan","Tali nipis supaya buaian lebih ringan"],b:0,u:"Lantai lembut memanjangkan masa hentaman dan mengurangkan kecederaan."},
 {j:"pilih",t:"Awak mahu menjana elektrik daripada basikal senaman di sekolah. Idea paling praktikal?",p:["Sambung roda kepada generator kecil untuk mengecas lampu","Pasang panel suria kecil pada tempat duduk setiap basikal","Sambung basikal terus kepada soket dinding","Guna basikal tanpa rantai supaya lebih ringan"],b:0,u:"Generator menukar tenaga kinetik roda kepada tenaga elektrik."},
 ...
 {j:"pilih",t:"Bajet sekolah terhad untuk membina gelongsor. Cara paling kreatif?",p:["Guna cerun bukit sedia ada","Bina menara besi setinggi 20 m","Beli gelongsor import paling mahal","Batalkan projek taman permainan"],b:0,u:"Cerun semula jadi sudah menyediakan ketinggian dan tenaga keupayaan secara percuma."},
 {j:"pilih",t:"Bagaimanakah awak menguji sama ada pelancar bola kertas rekaan awak lebih baik daripada rekaan rakan?",p:["Lancar kedua-duanya berulang kali dengan bola sama","Lancar sekali sahaja dan pilih yang kelihatan kuat","Tanya guru rekaan mana yang lebih cantik","Guna bola berbeza bagi setiap rekaan"],b:0,u:"Ulangan dan bola yang sama menjadikan perbandingan adil."},
 {j:"pilih",t:"Taman permainan awak turut digunakan oleh kanak-kanak kurang upaya. Pertimbangan paling wajar?",p:["Sediakan permainan yang boleh dicapai dengan kerusi roda","Bina semua permainan setinggi mungkin","Sediakan permainan untuk kanak-kanak biasa sahaja seperti sebelum ini","Letakkan tangga curam di setiap pintu masuk"],b:0,u:"Reka bentuk yang baik boleh digunakan oleh semua anggota masyarakat."},
 {j:"pilih",t:"Penduduk mengadu buaian berkeriut kuat pada waktu malam. Penyelesaian paling wajar?",p:["Minyakkan engsel untuk mengurangkan geseran dan bunyi","Tanggalkan terus semua buaian di taman","Tambah beban pada buaian supaya ia kurang berayun pada waktu malam","Abaikan aduan kerana taman itu milik awam"],b:0,u:"Bunyi keriut ialah tenaga yang terbazir akibat geseran."}],
 bos:{j:"buka",
