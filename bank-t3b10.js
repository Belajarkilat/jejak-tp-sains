/* Bank soalan — Sains Ting. 3 · Bab 10 Penerokaan Angkasa Lepas.
   DIJANA. Jangan sunting fail ini terus; sunting sumber/t3b10.js
   kemudian jalankan: node bina.js t3b10
...
window.BANK["t3b10"] =
{
 "id": "t3b10",
 "tingkatan": 3,
 "kod": "10.0 Penerokaan Angkasa Lepas",
 ...
 "aras": [
  {
   ...
   "bosKadNama": "Sputnik 1",
   "bosKadEm": "🛰",
   "bosKadFakta": "Sputnik 1 dilancarkan pada tahun 1957 dan menjadi satelit buatan manusia yang pertama.",
   "soalan": [
    {
     "j": "pilih",
     ...
     "b": 0,
     "u": "Geo bermaksud Bumi, dan helio bermaksud Matahari."
    },
    {
     "j": "pilih",
     "t": "Ahli astronomi yang mencadangkan model geosentrik ialah:",
     "p": [
      "Copernicus",
      "Ptolemy",
      "Kepler",
     ...
     "b": 1,
     "u": "Model Ptolemy digunakan selama lebih seribu tahun."
    },
    {
     "j": "pilih",
     "t": "Ahli astronomi yang memperkenalkan model heliosentrik pada abad ke-16 ialah:",
     "p": [
      "Ptolemy",
      "Aristotle",
      "Copernicus",
     ...
     "b": 2,
     "u": "Copernicus meletakkan Matahari di pusat dengan planet mengorbit dalam bulatan."
    },
    {
     "j": "pilih",
     "t": "Kepler mendapati planet mengorbit Matahari dalam bentuk:",
     "p": [
      "Bulatan sempurna",
      "Segi empat",
      "Garis lurus",
     ...
     "b": 3,
     "u": "Matahari berada pada satu fokus elips itu."
    },
    {
     "j": "pilih",
     "t": "Satelit buatan manusia yang pertama ialah:",
     "p": [
      "Sputnik 1",
      "Apollo 11",
      "TiungSAT-1",
     ...
     "b": 0,
     "u": "Sputnik 1 dilancarkan oleh Kesatuan Soviet pada tahun 1957."
    },
    {
     "j": "pilih",
     "t": "Angkasawan pertama Malaysia ialah:",
     "p": [
      "Neil Armstrong",
     ...
     "b": 1,
     "u": "Dato' Dr. Sheikh Muszaphar Shukor ke Stesen Angkasa Antarabangsa pada tahun 2007."
    },
    {
     "j": "pilih",
     "t": "Teknologi mengumpul maklumat tentang permukaan Bumi dari jauh menggunakan satelit dipanggil:",
     "p": [
      "Pelakuran nuklear",
      "Elektrolisis",
      "Penderiaan jauh",
     ...
     "b": 2,
     "u": "Di Malaysia, penderiaan jauh diuruskan oleh Agensi Remote Sensing Malaysia, kini sebahagian daripada Agensi Angkasa Malaysia (MYSA)."
    },
    {
     "j": "banyak",
     "t": "Pilih SEMUA contoh teknologi penerokaan angkasa lepas.",
     "p": [
      "Roket",
      "Satelit",
      "Kuar angkasa",
     ...
     "u": "Kapal selam dan kereta api laju digunakan di Bumi."
    }
   ],
   "bos": {
    "j": "susun",
    "t": "Susun peristiwa penerokaan angkasa lepas berikut mengikut urutan masa.",
    "p": [
     "Pelancaran Sputnik 1",
     "Yuri Gagarin ke angkasa",
     "Neil Armstrong mendarat di Bulan",
     "Angkasawan Malaysia ke stesen angkasa"
    ],
    "b": [
     0,
     1,
  ...
  },
  {
   ...
   "bosKadNama": "Galileo",
   "bosKadEm": "🔭",
   "bosKadFakta": "Galileo menggunakan teleskop untuk menemui bulan-bulan Musytari, bukti bahawa bukan semua jasad mengorbit Bumi.",
   "soalan": [
    {
     "j": "pilih",
     "t": "Mengapakah model geosentrik diterima selama lebih seribu tahun?",
     "p": [
      "Model itu dibuktikan dengan teleskop moden",
      "Semua planet memang mengorbit Bumi",
      "Ptolemy mengambil gambar Sistem Suria dari angkasa lepas",
      "Dari Bumi, langit kelihatan berputar mengelilingi kita"
     ],
     "b": 3,
     "u": "Tanpa teleskop, pemerhatian harian kelihatan menyokong Bumi di pusat."
    },
    {
     "j": "pilih",
     ...
     "b": 0,
     "u": "Ramalan orbit bulatan Copernicus tidak tepat sepenuhnya dengan pemerhatian."
    },
    {
     "j": "pilih",
     "t": "Mengapakah roket membawa oksigennya sendiri?",
     "p": [
      "Oksigen menjadikan roket lebih ringan",
      "Tiada oksigen di angkasa untuk membakar bahan api",
      "Angkasawan perlu bernafas melalui enjin roket",
      "Oksigen menyejukkan badan roket semasa pelancaran"
     ],
     "b": 1,
     "u": "Pembakaran memerlukan oksigen, jadi roket membawa oksigen cecair."
    },
    {
     "j": "pilih",
     ...
     "p": [
      ...
      "Gas ditolak ke bawah, lalu gas menolak roket ke atas",
      "Roket menolak tanah dengan kaki besinya"
     ],
     "b": 2,
     "u": "Setiap tindakan mempunyai tindak balas yang sama besar dan bertentangan arah."
    },
    {
     "j": "pilih",
     "t": "Mengapakah roket dibina dalam beberapa peringkat?",
     "p": [
      "Setiap peringkat membawa angkasawan yang berbeza",
      "Supaya roket kelihatan lebih tinggi dan menarik",
      "Peringkat itu digunakan semula di angkasa sebagai rumah",
      "Peringkat kosong dibuang supaya jisim roket berkurang"
     ],
     "b": 3,
     "u": "Roket yang lebih ringan memerlukan kurang bahan api untuk terus memecut."
    },
    {
     "j": "pilih",
     ...
     "b": 0,
     "u": "Satelit dan Bumi berputar bersama, jadi satelit kekal di atas titik yang sama."
    },
    {
     "j": "pilih",
     "t": "Bagaimanakah penderiaan jauh membantu pengurusan bencana banjir?",
     "p": [
      "Satelit menyerap air banjir dari angkasa",
      "Imej satelit menunjukkan kawasan banjir dengan cepat",
      "Satelit menghalang hujan daripada turun",
      "Imej satelit hanya boleh digunakan selepas air banjir surut"
     ],
     "b": 1,
     "u": "Pasukan penyelamat boleh merancang laluan dan keutamaan dengan lebih cepat."
    },
    {
     "j": "pilih",
     "t": "Mengapakah model heliosentrik dianggap lebih baik daripada model geosentrik?",
     "p": [
      "Ia meletakkan Bumi sebagai pusat alam semesta",
      "Ia tidak memerlukan sebarang pemerhatian",
      "Ia menerangkan pergerakan planet dengan lebih mudah",
      "Ia dicadangkan lebih awal daripada model geosentrik"
     ],
     "b": 2,
     "u": "Model geosentrik memerlukan banyak bulatan kecil tambahan untuk menerangkan pergerakan planet."
    }
   ],
   "bos": {
    "j": "pilih",
    "t": "Mengapakah penerokaan angkasa lepas memerlukan kerjasama antarabangsa, seperti Stesen Angkasa Antarabangsa?",
    "p": [
     "Angkasa lepas milik satu negara sahaja",
     "Roket hanya boleh dilancarkan dari satu negara",
     "Angkasawan tidak dibenarkan bekerja seorang diri di angkasa",
     "Kosnya sangat tinggi dan kepakaran perlu dikongsi"
    ],
    "b": 3,
    "u": "Stesen Angkasa Antarabangsa dibina dan dikendalikan bersama oleh beberapa agensi angkasa."
   }
  },
  {
   "n": 3,
   "tempat": "Orbit Planet",
   "sk": "10.1 Mengaplikasi pengetahuan model Sistem Suria",
   "lampiran": "orbit",
   "kadNama": "Tahun Musytari",
   "kadEm": "📅",
   "kadFakta": "Satu tahun di Musytari bersamaan hampir 12 tahun di Bumi.",
   "bosKadNama": "Unit Astronomi",
   "bosKadEm": "📏",
   "bosKadFakta": "Satu unit astronomi ialah jarak purata Bumi ke Matahari, kira-kira 150 juta km.",
   "soalan": [
    {
     "j": "pilih",
     "t": "Berdasarkan jadual, apakah hubungan antara jarak planet dari Matahari dengan tempoh orbitnya?",
     "p": [
      "Semakin jauh, semakin lama tempoh orbit",
      "Semakin jauh, semakin singkat tempoh orbit",
      "Jarak tidak mempengaruhi tempoh orbit",
      "Semua planet mempunyai tempoh orbit yang sama"
     ],
     "b": 0,
     "u": "Tempoh orbit meningkat dari 0.24 tahun bagi Utarid kepada 11.86 tahun bagi Musytari."
    },
    {
     "j": "nombor",
     "t": "Berapa hari Bumi dalam satu tahun Utarid? Gunakan 1 tahun = 365 hari dan bundarkan kepada nombor bulat.",
     "b": 88,
     "tol": 1,
     "suf": "hari",
     "u": "0.24 × 365 = 87.6, iaitu kira-kira 88 hari."
    },
    {
     "j": "pilih",
     "t": "Berapakah umur seorang murid berusia 15 tahun Bumi jika dikira dalam tahun Marikh?",
     "p": [
      "Kira-kira 28 tahun",
      "Kira-kira 8 tahun",
      "Kira-kira 15 tahun",
     ...
     "b": 1,
     "u": "15 ÷ 1.88 ≈ 8 tahun Marikh."
    },
    {
     "j": "pilih",
     "t": "Planet manakah mengambil masa paling lama untuk melengkapkan satu orbit?",
     "p": [
      "Utarid",
      "Bumi",
      "Musytari",
     ...
     "b": 2,
     "u": "Musytari paling jauh dalam jadual."
    },
    {
     "j": "pilih",
     "t": "Seorang murid mendakwa Zuhrah mempunyai tahun yang lebih panjang daripada Bumi. Semak dakwaan itu.",
     "p": [
      "Betul, kerana Zuhrah lebih besar dan lebih berat daripada Bumi",
      "Betul, kerana Zuhrah lebih jauh dari Matahari",
      "Salah, kerana Zuhrah tidak mengorbit Matahari",
      "Salah, kerana tempoh orbit Zuhrah hanya 0.62 tahun Bumi"
     ],
     "b": 3,
     "u": "Zuhrah lebih dekat dengan Matahari, jadi tahunnya lebih singkat."
    },
    {
     "j": "pilih",
     "t": "Mengapakah model heliosentrik sesuai untuk menerangkan data dalam jadual?",
     "p": [
      "Semua orbit dalam jadual berpusat pada Matahari",
      "Semua planet dalam jadual sebenarnya mengorbit Bumi",
      "Jadual itu langsung tidak melibatkan Matahari",
      "Tempoh orbit Bumi dalam jadual ialah sifar"
     ],
     "b": 0,
     "u": "Jarak dalam jadual diukur dari Matahari."
    },
    {
     "j": "pilih",
     "t": "Kapal angkasa ke Marikh biasanya dilancarkan hanya pada tempoh tertentu. Penjelasan paling munasabah?",
     "p": [
      "Marikh hilang dari Sistem Suria pada masa lain",
      "Kedudukan Bumi dan Marikh hanya sesuai sekali-sekala",
      "Roket hanya boleh dilancarkan pada waktu malam",
      "Graviti Bumi terlalu kuat untuk dilawan pada kebanyakan masa"
     ],
     "b": 1,
     "u": "Tempoh orbit yang berbeza menyebabkan kedua-dua planet berada pada kedudukan terbaik lebih kurang setiap dua tahun."
    },
    {
     "j": "pilih",
     "t": "Seorang murid mahu melukis model Sistem Suria mengikut skala untuk kelas. Cara paling sesuai?",
     "p": [
      "Letakkan semua planet pada jarak yang sama",
      "Lukis Bumi di pusat seperti model Ptolemy yang terkenal",
      "Guna jarak dalam jadual sebagai nisbah, 1 AU = 10 cm",
      "Lukis planet mengikut warna kegemaran sahaja"
     ],
     "b": 2,
     "u": "Nisbah yang tetap mengekalkan perbandingan jarak sebenar."
    }
   ],
   "bos": {
    "j": "nombor",
    "t": "Jika 1 AU diwakili oleh 10 cm, berapakah jarak Musytari dari Matahari dalam model itu, dalam cm?",
    "b": 52,
    "tol": 0.5,
    "suf": "cm",
    "u": "5.20 × 10 cm = 52 cm."
  ...
  {
   "n": 4,
   "tempat": "Orbit Satelit",
   "sk": "10.2 Menganalisis teknologi satelit",
   "lampiran": "satelit",
   "kadNama": "Stesen Angkasa",
   "kadEm": "🌍",
   "kadFakta": "Stesen Angkasa Antarabangsa mengorbit Bumi kira-kira 16 kali sehari.",
   "bosKadNama": "Geopegun",
   "bosKadEm": "📡",
   "bosKadFakta": "Satelit geopegun berada kira-kira 36 000 km di atas khatulistiwa dan mengorbit sekali setiap 24 jam.",
   "soalan": [
    {
     "j": "pilih",
     "t": "Berdasarkan jadual, apakah hubungan antara ketinggian orbit dengan tempoh satu orbit?",
     "p": [
      "Semakin tinggi, semakin singkat tempoh orbit",
      "Ketinggian tidak mempengaruhi tempoh orbit",
      "Semua satelit mengambil masa 24 jam",
      "Semakin tinggi, semakin lama tempoh orbit"
     ],
     "b": 3,
     "u": "Tempoh bertambah dari 90 minit pada 400 km kepada 24 jam pada 35 786 km."
    },
    {
     "j": "pilih",
     "t": "Mengapakah piring satelit TV di rumah tidak perlu dipusingkan untuk mengikut satelit?",
     "p": [
      "Satelit geopegun sentiasa berada di atas titik yang sama",
      "Satelit bergerak terlalu laju untuk dikesan",
      "Piring satelit sebenarnya menerima isyarat dari menara di tanah sahaja",
      "Satelit komunikasi berada pada ketinggian 400 km"
     ],
     "b": 0,
     "u": "Tempoh orbitnya 24 jam, sama dengan putaran Bumi."
    },
    {
     "j": "nombor",
     "t": "Berapa kali Stesen Angkasa Antarabangsa mengorbit Bumi dalam 24 jam? Bundarkan kepada nombor bulat.",
     "b": 16,
     "tol": 0.5,
     "suf": "kali",
     "u": "24 jam = 1440 minit. 1440 ÷ 90 = 16 kali."
    },
    {
     "j": "pilih",
     "t": "Satelit manakah paling sesuai untuk mengambil imej terperinci ladang sawit?",
     "p": [
      "Satelit komunikasi geopegun",
      "Satelit penderiaan jauh",
      "Satelit GPS",
      "Semua sama sesuai"
     ],
     "b": 1,
     "u": "Satelit penderiaan jauh dibina khas untuk memerhati permukaan Bumi."
    },
    {
     "j": "pilih",
     "t": "Mengapakah satelit penderiaan jauh diletakkan lebih rendah daripada satelit geopegun?",
     "p": [
      "Lebih murah kerana satelit rendah tidak perlu bahan api langsung",
      "Satelit rendah tidak terjejas oleh graviti",
      "Lebih dekat dengan Bumi, jadi imej lebih terperinci",
      "Satelit tinggi tidak boleh mengambil gambar"
     ],
     "b": 2,
     "u": "Jarak yang dekat membolehkan butiran kecil di permukaan dirakam."
    },
    {
     "j": "pilih",
     "t": "Penerima GPS memerlukan isyarat daripada sekurang-kurangnya empat satelit. Mengapakah terdapat banyak satelit GPS di angkasa?",
     "p": [
      "Supaya setiap negara mempunyai satelit sendiri",
      "Kerana satelit GPS cepat rosak setiap minggu",
      "Supaya satelit dapat saling berlanggar dengan selamat",
      "Supaya cukup satelit kelihatan dari mana-mana tempat"
     ],
     "b": 3,
     "u": "Satelit GPS sentiasa bergerak, jadi banyak satelit diperlukan untuk liputan seluruh dunia."
    },
    {
     "j": "banyak",
     "t": "Pilih SEMUA kegunaan penderiaan jauh.",
     "p": [
      "Memantau kesihatan tanaman",
      "Mengesan kawasan banjir",
      "Memetakan kawasan hutan",
      "Menyiarkan rancangan televisyen",
      "Menentukan kedudukan kereta dengan tepat"
     ],
     "b": [
      0,
      1,
     ...
     "u": "Siaran TV ialah kerja satelit komunikasi, dan kedudukan kereta ditentukan oleh GPS."
    },
    {
     "j": "pilih",
     ...
     "b": 0,
     "u": "Kebanyakan serpihan kecil terbakar di atmosfera, tetapi di orbit ia bergerak sangat laju."
    }
   ],
   "bos": {
    "j": "pilih",
    "t": "Sebuah satelit baharu perlu memberi liputan televisyen berterusan ke seluruh Malaysia. Orbit paling sesuai?",
    "p": [
     "Orbit rendah pada kira-kira 400 km",
     "Orbit geopegun pada kira-kira 35 786 km",
     "Orbit GPS pada kira-kira 20 200 km",
     "Mana-mana orbit kerana semuanya sama"
    ],
    "b": 1,
    "u": "Hanya satelit geopegun kekal di atas kawasan yang sama sepanjang masa."
   }
  },
  {
   "n": 5,
   "tempat": "Agensi Angkasa",
   "sk": "10.2.2 Mewajarkan penerokaan angkasa lepas",
   "lampiran": "misi",
   "kadNama": "TiungSAT-1",
   "kadEm": "🛰",
   "kadFakta": "TiungSAT-1 yang dilancarkan pada tahun 2000 ialah satelit mikro pertama Malaysia.",
   "bosKadNama": "Sampah Angkasa",
   "bosKadEm": "🗑",
   "bosKadFakta": "Serpihan sekecil kepingan cat pun boleh merosakkan kapal angkasa kerana bergerak pada kelajuan yang sangat tinggi.",
   "soalan": [
    {
     "j": "pilih",
     "t": "Dengan bajet RM500 juta, gabungan misi manakah boleh dilaksanakan?",
     "p": [
      "R sahaja",
      "P dan R",
      "P dan Q",
    ...
    {
     "j": "banyak",
     "t": "Pilih SEMUA langkah yang wajar untuk mengurangkan sampah angkasa daripada misi baharu.",
     "p": [
  ...
  {
   "n": 6,
   "tempat": "Pelancar Roket",
   "sk": "10.2 Mereka cipta dalam penerokaan angkasa",
   "lampiran": null,
   "kadNama": "Roket Air",
   "kadEm": "💦",
   "kadFakta": "Roket air terbang kerana air ditolak keluar ke bawah, lalu air menolak roket ke atas.",
   "bosKadNama": "Voyager 1",
   "bosKadEm": "🚀",
   "bosKadFakta": "Voyager 1 yang dilancarkan pada tahun 1977 ialah objek buatan manusia yang paling jauh dari Bumi.",
   "soalan": [
    {
     "j": "pilih",
