...
'</tbody></table></div><p class="qnote">Kadar dos latar belakang semula jadi biasanya antara 0.05 dan 0.3 &micro;Sv/j, bergantung pada tempat. Had dos tambahan ialah 1 mSv (1000 &micro;Sv) setahun bagi orang awam dan 20 mSv setahun bagi pekerja sinaran. Data rekaan untuk latihan.</p>';
...
{n:3, tempat:"Kebuk Awan", sk:"8.1 / 8.4 Separuh hayat dan kegunaan sinaran", lampiran:"reput",
 ...
 {j:"pilih",t:"Sebuah kilang mengawal ketebalan kepingan kertas menggunakan sumber beta. Mengapakah beta sesuai?",p:["Beta separa menembusi kertas","Beta tidak dapat menembusi kertas walaupun nipis","Beta menembusi plumbum tebal dengan mudah","Beta tidak mengionkan bahan langsung"],b:0,u:"Alfa dihalang sepenuhnya oleh kertas, dan gama hampir tidak terjejas, jadi hanya beta yang peka terhadap ketebalan."},
...
{n:5, tempat:"Pusat Nuklear", sk:"8.3 / 8.4 Mengurus risiko sinaran", lampiran:"dos",
 ...
 soalan:[
 {j:"pilih",t:"Berdasarkan jadual, lokasi manakah mempunyai kadar dos paling tinggi, dan apakah puncanya?",p:["Kabin kapal terbang, kerana sinaran kosmik lebih kuat di altitud tinggi","Tepi tapak sisa radioaktif, kerana sisa memancarkan sinaran paling kuat","Kawasan granit, kerana batuan granit memancarkan sinar-X","Kabin kapal terbang, kerana enjin kapal terbang memancarkan sinar gama"],b:0,u:"Di altitud tinggi, lapisan atmosfera yang melindungi daripada sinaran kosmik lebih nipis. Kadar di tepi pagar tapak sisa jauh lebih rendah daripada kabin."},
 {j:"pilih",t:"Seorang kru kabin terbang 800 jam setahun pada kadar dalam jadual. Anggaran dos tambahannya dan keputusan paling wajar?",p:["Kira-kira 2.4 mSv; pantau dos kru dan hadkan jam terbang","Kira-kira 2.4 mSv; hentikan semua penerbangan kru itu serta-merta","Kira-kira 0.24 mSv; tiada pemantauan diperlukan","Kira-kira 24 mSv; kru itu sudah melebihi had pekerja sinaran"],b:0,u:"800 jam × 3.0 µSv/j = 2400 µSv = 2.4 mSv. Ia di bawah had pekerja 20 mSv tetapi melebihi had orang awam, jadi kru dipantau sebagai pekerja sinaran."},
 {j:"nombor",t:"Berapakah dos yang diterima seorang penumpang dalam penerbangan selama 5 jam, dalam µSv?",b:15,tol:0.05,suf:"µSv",u:"3.0 µSv/j × 5 jam = 15 µSv, iaitu sebahagian kecil sahaja daripada had tahunan orang awam."},
 {j:"pilih",t:"Nilaikan dakwaan: \"Kawasan granit langsung tidak selamat didiami.\"",p:["Tidak tepat, kerana 0.25 µSv/j masih dalam julat latar belakang semula jadi","Tepat, kerana kadarnya lebih tinggi daripada bilik darjah","Tepat, kerana semua sinaran mengion berbahaya walaupun sedikit","Tidak tepat, kerana granit langsung tidak memancarkan sinaran"],b:0,u:"Granit memang memancarkan sedikit sinaran dan gas radon, tetapi kadarnya dalam julat semula jadi. Pengudaraan yang baik mengurangkan radon di dalam rumah."},
 {j:"pilih",t:"Sebuah syarikat mahu membina tapak simpanan sisa radioaktif. Lokasi paling wajar?",p:["Kawasan geologi stabil yang jauh dari sumber air dan penduduk","Tepi sungai supaya sisa mudah diangkut dan sentiasa disejukkan","Berhampiran hospital kerana hospital sudah biasa mengendalikan sinaran","Tanah paya kerana air di situ menghalang sinaran daripada keluar"],b:0,u:"Sisa radioaktif boleh kekal aktif untuk tempoh yang sangat lama. Air tanah dan sungai boleh membawa bahan radioaktif jauh dari tapak."},
 {j:"pilih",t:"Sebuah hospital mahu membeli mesin radioterapi kobalt-60. Syarat paling penting untuk diwajibkan?",p:["Bilik berdinding konkrit tebal dan pekerja memakai lencana dos","Bilik berdinding aluminium kerana aluminium menghalang sinar gama","Pekerja berdiri dekat sumber supaya rawatan lebih tepat","Sumber disimpan dalam bekas plastik tebal selepas digunakan"],b:0,u:"Sinar gama hanya dikurangkan dengan ketara oleh konkrit tebal atau plumbum. Jarak yang jauh mengurangkan dos pekerja."},
 {j:"banyak",t:"Pilih SEMUA langkah yang wajar bagi pekerja yang mengendalikan bahan radioaktif.",p:["Gunakan penyepit berpemegang panjang","Pakai lencana dos untuk memantau pendedahan","Simpan sumber dalam bekas plumbum","Pakai sarung tangan getah untuk menghalang sinar gama","Bekerja lebih perlahan supaya tidak tersilap"],b:[0,1,2],u:"Jarak, perisai dan masa pendedahan yang singkat mengurangkan dos. Sarung tangan getah tidak menghalang sinar gama."},
 {j:"pilih",t:"Sesetengah pengguna menolak makanan yang diawet dengan sinar gama kerana takut makanan itu radioaktif. Nilaikan kebimbangan itu.",p:["Tidak berasas, kerana makanan itu tidak menjadi radioaktif","Berasas, kerana sinar gama kekal tersimpan di dalam makanan","Berasas, kerana makanan itu memancarkan sinaran selepas disinari","Tidak berasas, kerana sinar gama tidak dapat menembusi makanan"],b:0,u:"Sinar gama melalui makanan dan membunuh mikroorganisma, tetapi tidak tertinggal di dalamnya. Ia menembusi makanan, dan itulah sebabnya ia berkesan."}],
 bos:{j:"pilih",t:"Sebuah negara menimbang pembinaan loji tenaga nuklear untuk mengurangkan pembakaran arang batu. Pertimbangan paling wajar sebelum keputusan dibuat?",p:["Timbang tenaga bersih dengan risiko kemalangan dan sisa","Bina segera kerana loji nuklear tidak menghasilkan sebarang sisa","Tolak kerana loji nuklear membebaskan lebih banyak karbon dioksida","Bina di pantai zon gempa kerana air laut menyejukkan reaktor"],b:0,u:"Loji nuklear hampir tidak membebaskan karbon dioksida, tetapi menghasilkan sisa radioaktif. Fukushima menunjukkan bahaya lokasi di zon gempa dan tsunami."}},
...
{n:6, tempat:"Pameran Sains", sk:"8.4 Mereka cipta untuk kesejahteraan hidup",
 ...
 soalan:[
 {j:"pilih",t:"Awak mereka poster untuk mendidik penduduk tentang gas radon di rumah. Mesej paling tepat?",p:["Buka tingkap untuk pengudaraan dan uji paras radon jika risau","Pindah rumah serta-merta jika tinggal di kawasan berbatu","Tutup tingkap rapat-rapat supaya radon tidak dapat masuk","Tanam pokok di sekeliling rumah kerana pokok menyerap radon"],b:0,u:"Radon datang dari tanah di bawah rumah, jadi menutup tingkap memerangkapnya di dalam. Pengudaraan mengurangkannya."},
 {j:"pilih",t:"Awak membina model kebuk awan untuk pameran. Apakah yang dapat ditunjukkan olehnya?",p:["Runut yang dihasilkan oleh sinaran","Separuh hayat sumber radioaktif dengan tepat","Cara menghentikan sinaran daripada keluar ke kelas","Perbezaan antara sinar gama dengan sinar-X"],b:0,u:"Sinaran tidak kelihatan, tetapi runutnya dalam kebuk awan boleh dilihat. Runut alfa pendek dan tebal, runut beta nipis dan berliku."},
 {j:"pilih",t:"Pameran awak akan dilawati kanak-kanak. Langkah keselamatan paling penting?",p:["Guna gambar, model dan simulasi, bukan sumber sebenar","Guna sumber alfa sahaja kerana alfa tidak menembusi kulit","Letak sumber gama di belakang sekeping kertas tebal","Benarkan kanak-kanak memegang sumber jika memakai sarung tangan"],b:0,u:"Alfa sangat berbahaya jika tertelan atau terhidu. Kertas tidak menghalang sinar gama, dan sarung tangan tidak melindungi daripada sinar gama."},
 {j:"pilih",t:"Awak mereka kempen tentang kegunaan radioisotop dalam pertanian. Contoh yang paling tepat?",p:["Menghasilkan varieti padi baharu melalui mutasi","Menyinari padi setiap hari supaya ia membesar lebih cepat","Mengawet buah dengan sinar gama sehingga buah itu radioaktif","Menggantikan baja dengan bahan radioaktif yang lebih murah"],b:0,u:"Sinaran mengubah bahan genetik benih dan menghasilkan varieti yang boleh dipilih. Buah yang diawet dengan sinar gama tidak menjadi radioaktif."},
 {j:"pilih",t:"Awak mahu menunjukkan konsep separuh hayat tanpa bahan radioaktif. Simulasi paling tepat?",p:["Lambung 100 syiling berulang kali dan buang yang menunjukkan kepala","Lambung satu syiling 100 kali dan rekod setiap keputusan","Buang 10 syiling pada setiap pusingan sehingga semuanya habis","Kira masa yang diambil untuk 100 ketul ais cair sepenuhnya"],b:0,u:"Kira-kira separuh syiling yang tinggal dibuang setiap pusingan, sama seperti separuh nukleus yang tinggal mereput setiap separuh hayat. Membuang 10 setiap kali ialah pengurangan tetap, bukan separuh hayat."},
 {j:"pilih",t:"Bagaimanakah awak menilai sama ada pameran berjaya meningkatkan kefahaman pengunjung?",p:["Beri kuiz ringkas sebelum dan selepas lawatan","Kira bilangan gambar yang diambil oleh pengunjung","Tanya pengunjung sama ada pameran itu menarik","Kira berapa lama pengunjung berdiri di setiap poster"],b:0,u:"Perbandingan sebelum dan selepas menunjukkan perubahan kefahaman, bukan sekadar minat."},
 {j:"pilih",t:"Penduduk berhampiran sebuah kilang nadir bumi bimbang tentang sisa radioaktif. Pendekatan komunikasi paling wajar?",p:["Kongsi data pemantauan secara terbuka","Rahsiakan data supaya penduduk tidak panik","Kongsi data hanya apabila bacaannya rendah","Beritahu penduduk semua sinaran tidak berbahaya"],b:0,u:"Ketelusan membina kepercayaan. Berkongsi data yang baik sahaja, atau menafikan semua risiko, merosakkan kepercayaan itu."},
 {j:"pilih",t:"Awak mahu menerangkan sinaran mengion kepada warga emas yang tidak biasa dengan istilah sains. Cara paling sesuai?",p:["Guna analogi mudah dan contoh seperti sinar-X di klinik","Guna istilah teknikal sahaja supaya penjelasan tepat","Tekankan bahawa semua sinaran boleh membawa maut","Elakkan topik itu supaya mereka tidak risau"],b:0,u:"Mesej yang baik tepat dan disesuaikan dengan pendengar. Menakut-nakutkan sama mengelirukan seperti menafikan risiko."}],
 bos:{j:"buka",
