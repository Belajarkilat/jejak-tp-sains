...
{n:2, tempat:"Model Suria", sk:"10.1 / 10.2 Memahami model dan teknologi angkasa",
 ...
 {j:"pilih",t:"Apakah kelebihan model Kepler berbanding model Copernicus?",p:["Orbit elips meramal kedudukan planet dengan lebih tepat","Model Kepler meletakkan Bumi semula di pusat Sistem Suria","Model Kepler tidak memerlukan Matahari","Model Kepler menggunakan orbit segi empat"],b:0,u:"Ramalan orbit bulatan Copernicus tidak tepat sepenuhnya dengan pemerhatian."},
 ...
 {j:"pilih",t:"Mengapakah satelit komunikasi geopegun kelihatan tidak bergerak dari Bumi?",p:["Tempoh orbitnya sama dengan tempoh putaran Bumi","Satelit itu terapung pegun tanpa bergerak","Satelit itu terlalu jauh untuk dilihat bergerak","Satelit itu diikat pada Bumi dengan kabel"],b:0,u:"Satelit dan Bumi berputar bersama, jadi satelit kekal di atas titik yang sama."},
...
{n:4, tempat:"Orbit Satelit", sk:"10.2 Menganalisis teknologi satelit", lampiran:"satelit",
 ...
 {j:"pilih",t:"Sampah angkasa semakin banyak di orbit rendah. Analisis risiko terbesarnya.",p:["Serpihan boleh melanggar dan merosakkan satelit atau stesen angkasa","Sampah angkasa jatuh ke Bumi setiap hari dan memusnahkan banyak bandar","Sampah angkasa menghalang cahaya Matahari sampai ke Bumi","Sampah angkasa tidak mempunyai sebarang kesan"],b:0,u:"Kebanyakan serpihan kecil terbakar di atmosfera, tetapi di orbit ia bergerak sangat laju."}],
...
{n:5, tempat:"Agensi Angkasa", sk:"10.2.2 Mewajarkan penerokaan angkasa lepas", lampiran:"misi",
 ...
 soalan:[
 {j:"pilih",t:"Dengan bajet RM500 juta, gabungan misi manakah boleh dilaksanakan?",p:["P dan Q","R sahaja","P dan R","Q dan R"],b:0,u:"P dan Q berjumlah RM400 juta. Misi R sahaja sudah RM2500 juta."},
 {j:"pilih",t:"Dalam bajet itu, misi manakah memberi manfaat paling langsung kepada rakyat?",p:["Misi P, kerana amaran bencana melindungi jutaan penduduk","Misi R, kerana misi paling mahal pasti paling berguna","Misi Q sahaja, kerana angkasawan terkenal","Tiada misi, kerana angkasa tiada manfaat"],b:0,u:"Misi R juga di luar bajet."},
 {j:"pilih",t:"Nilaikan dakwaan: \"Wang penerokaan angkasa lebih baik digunakan untuk masalah di Bumi sahaja.\"",p:["Separuh wajar, kerana teknologi angkasa turut membantu Bumi","Tepat sepenuhnya, kerana angkasa tiada kaitan dengan Bumi","Salah sepenuhnya, kerana masalah di Bumi tidak penting","Tepat, kerana satelit tidak pernah membantu sesiapa"],b:0,u:"Ramalan cuaca, GPS dan pemantauan bencana semuanya bergantung pada teknologi angkasa."},
 {j:"pilih",t:"Satelit pemantau jerebu (Misi P) memerlukan data tanah untuk pengesahan. Keputusan paling wajar?",p:["Gabungkan data satelit dengan stesen udara di tanah","Gunakan data satelit sahaja tanpa semakan","Tutup semua stesen di tanah untuk jimat kos","Tunggu jerebu hilang sepenuhnya sebelum mula menganalisis data"],b:0,u:"Data dari dua sumber saling mengesahkan."},
 {j:"pilih",t:"Sebuah syarikat menawarkan pelancaran murah tetapi rekod keselamatannya lemah. Keputusan paling wajar bagi Misi P?",p:["Pilih pelancar yang lebih selamat walaupun mahal sedikit","Pilih pelancar paling murah tanpa semakan","Batalkan terus Misi P kerana risiko pelancaran","Lancarkan satelit tanpa insurans langsung untuk menjimatkan kos"],b:0,u:"Kehilangan satelit RM300 juta jauh lebih mahal daripada perbezaan harga pelancaran."},
 {j:"banyak",t:"Pilih SEMUA langkah yang wajar untuk mengurangkan sampah angkasa daripada misi baharu.",p:["Rancang satelit jatuh ke atmosfera selepas tamat hayat","Kurangkan serpihan yang terlepas semasa pelancaran","Kongsi data orbit dengan agensi lain","Tinggalkan peringkat roket lama di orbit selama-lamanya","Letupkan satelit lama di orbit supaya menjadi kepingan kecil"],b:[0,1,2],u:"Meletupkan satelit menghasilkan lebih banyak serpihan berbahaya."},
 {j:"pilih",t:"Negara mahu murid lebih berminat dengan sains angkasa. Pilihan paling wajar dengan kos rendah?",p:["Program membina satelit kecil CubeSat bersama universiti","Hantar setiap murid ke angkasa","Bina roket sebenar sendiri di setiap sekolah menengah di negara ini","Hentikan pengajaran astronomi di sekolah"],b:0,u:"CubeSat murah dan memberi pengalaman membina satelit sebenar."},
 {j:"pilih",t:"Selepas banjir besar, agensi bantuan mempunyai imej satelit sehari selepas banjir dan laporan penduduk seminggu kemudian. Keputusan paling wajar?",p:["Guna imej satelit dahulu, kemudian sahkan dengan penduduk","Tunggu laporan penduduk sebelum bertindak","Guna laporan penduduk sahaja kerana imej satelit tidak tepat","Abaikan kedua-duanya dan tunggu arahan seterusnya"],b:0,u:"Bantuan perlu bergerak cepat, dan laporan penduduk menambah butiran yang tidak dilihat satelit."}],
 bos:{j:"pilih",t:"Negara mempertimbangkan untuk meneruskan program angkasa walaupun ekonomi perlahan. Hujah paling kukuh untuk meneruskannya?",p:["Data satelit membantu pertanian, cuaca dan bencana","Program angkasa menjadikan negara kelihatan lebih hebat di mata dunia","Negara lain juga mempunyai program angkasa","Angkasawan mendapat gaji yang sangat tinggi"],b:0,u:"Hujah yang kukuh menunjukkan manfaat sebenar kepada rakyat."}},
...
{n:6, tempat:"Pelancar Roket", sk:"10.2 Mereka cipta dalam penerokaan angkasa",
 ...
 soalan:[
 {j:"pilih",t:"Awak mereka roket air untuk pertandingan sekolah. Faktor paling penting untuk ketinggian maksimum?",p:["Isi padu air dan tekanan yang sesuai","Warna roket yang terang dan menarik","Botol plastik yang paling berat","Sirip yang dipasang secara rawak"],b:0,u:"Terlalu banyak air menambah jisim, manakala terlalu sedikit air mengurangkan tujahan."},
 {j:"pilih",t:"Roket air awak terbang tidak lurus. Pengubahsuaian paling wajar?",p:["Pasang sirip yang sama saiz secara simetri","Tambah lebih banyak air sehingga botol itu penuh","Buang semua sirip","Lancarkan pada hari berangin kencang"],b:0,u:"Sirip simetri menstabilkan arah penerbangan."},
 {j:"pilih",t:"Awak mereka cadangan satelit kecil untuk Malaysia. Kegunaan paling bermanfaat kepada rakyat?",p:["Memantau banjir, jerebu dan kesihatan tanaman","Menyiarkan iklan syarikat ke seluruh dunia","Mengambil gambar rumah orang tanpa izin","Mengawal cuaca supaya hujan tidak turun"],b:0,u:"Satelit tidak boleh mengawal cuaca, dan mengambil gambar tanpa izin melanggar privasi."},
 {j:"pilih",t:"Bajet projek roket air awak terhad. Bahan paling kreatif dan selamat?",p:["Botol plastik terpakai, kadbod dan pam basikal","Tabung gas bertekanan tinggi","Botol kaca terpakai kerana lebih kukuh dan keras","Bahan api petrol untuk tujahan lebih kuat"],b:0,u:"Botol kaca boleh pecah berkecai di bawah tekanan."},
 {j:"pilih",t:"Bagaimanakah awak menentukan reka bentuk sirip terbaik secara adil?",p:["Uji setiap sirip berulang kali dengan tekanan yang sama","Uji sekali sahaja bagi setiap reka bentuk","Tukar isi padu air dan tekanan setiap kali pelancaran dibuat","Pilih sirip yang kelihatan paling cantik"],b:0,u:"Hanya reka bentuk sirip yang patut berubah antara ujian."},
 {j:"pilih",t:"Kawasan pelancaran roket air awak berhampiran bangunan dan orang ramai. Keputusan paling wajar?",p:["Lancarkan di padang terbuka dengan zon selamat","Lancarkan di kantin supaya ramai menonton","Halakan roket ke arah bangunan","Tiada langkah diperlukan kerana roket air ringan"],b:0,u:"Roket air yang laju boleh mencederakan orang."},
 {j:"pilih",t:"Model satelit awak akan dipamerkan kepada murid sekolah rendah. Pendekatan paling berkesan?",p:["Tunjuk cara imej satelit membantu kehidupan mereka","Tulis penerangan panjang dalam istilah teknikal","Larang murid menyentuh atau bertanya","Tunjukkan model tanpa sebarang penerangan"],b:0,u:"Kanak-kanak lebih berminat apabila nampak kaitan dengan kehidupan sendiri."},
 {j:"pilih",t:"Awak mencadangkan pusat pelancaran roket kecil di sebuah negeri. Pertimbangan paling wajar?",p:["Kaji kesan kepada penduduk, alam dan keselamatan","Pilih tapak paling hampir dengan pusat bandar","Abaikan pendapat nelayan di kawasan itu","Bina tanpa kelulusan untuk menjimatkan masa"],b:0,u:"Pusat pelancaran menjejaskan ruang udara, laut dan penduduk di sekitarnya."}],
 bos:{j:"buka",
